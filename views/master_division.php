...
if(!App::checkAccess("MANAGE_DIVISION")){
	App::message("Sorry, you are not authorized to manage division", "warning");
	App::redirect(VSITE."?access=denied");
}

// default page
$url = "index.php?m=master_division";
...
if(isset($_GET['mode'])){
	...
	if(isset($_GET['id']) && is_numeric($_GET['id'])){
		...
		switch($_GET['mode']){
			case "edit":
				$edit = true;
				$details = new Divisi($id);
				break;
			case "delete":
				$details = Divisi::delete($id);
				if($details){
					App::redirect($url);
				}
				break;
            ...
            <div class="box-body">
			  <div class="col-lg-12">
				<div class="form-group">
					<label for="objname">Division Name <span class="required">*</span></label>
