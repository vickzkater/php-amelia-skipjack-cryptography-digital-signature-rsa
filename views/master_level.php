...
if(!App::checkAccess("MANAGE_LEVEL")){
	App::message("Sorry, you are not authorized to manage level", "warning");
	App::redirect(VSITE."?access=denied");
}

// default page
$url = "index.php?m=master_level";
...
if(isset($_GET['mode'])){
	...
	if(isset($_GET['id']) && is_numeric($_GET['id'])){
		...
		switch($_GET['mode']){
			case "edit":
				$edit = true;
				$details = new Level($id);
				break;
			case "delete":
				$details = Level::delete($id);
				if($details){
					App::redirect($url);
				}
				break;
            ...
            <div class="box-body">
			  <div class="col-lg-12">
				<div class="form-group">
					<label for="objname">Level Name <span class="required">*</span></label>
